...
export default function Skills() {
  ...
  return (
    <section ref={ref} id="skills" className="py-24 md:py-32 min-h-[400px] bg-black text-white relative border-t border-amber-500/20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {SKILLS_DATA.map((skill, index) => (
            ...
            >
              ...
              <span className="font-medium text-zinc-400 group-hover:text-amber-400 transition-colors text-center">
                {skill.name}
              </span>
            </motion.div>
          ))}
