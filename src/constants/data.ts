export const HERO_DATA = {
  ...
  description:
    "Passionné par le développement web et la création d'expériences digitales innovantes.",
  availability: {
    internship: {
      duration: "8 semaines",
...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    description:
      "Stage de 8 semaines chez Leading Frog : alimentation et développement du back-office statistique de l'application mobile de quiz musical Qzic.me.",
    context:
      "Stage réalisé chez Leading Frog, startup éditrice de Qzic.me, une application mobile de quiz musical liée à des événements. Ma mission portait sur le back-office statistique : chaque page suit le même flux — récupération des données via des endpoints PHP, traitement et agrégation côté serveur, puis transmission au front via attributs data-* pour affichage avec Chart.js. L'objectif était de donner a l'équipe une vision claire des performances de leurs quiz (participation, scores, évolutions) au travers de graphiques et de tableaux de bord.",
    difficulties:
      "Comprendre et s'approprier une base de code existante en PHP sans documentation exhaustive. Concevoir des graphiques Chart.js lisibles et pertinents (choix des types de graphiques, échelles, couleurs, légendes). Gérer la transmission des données serveur vers le front via des attributs data-* de manière fiable et maintenable. S'intégrer dans un flux de développement professionnel avec contraintes de délais et de qualité.",
    techs: ["PHP", "Chart.js", "Bootstrap 5"],
    date: "Été 2026",
    link: "",
    image: "/img/qzic_backoffice_1.png",
    screens: ["/img/qzic_backoffice_2.png"],
  },
  {
    id: "dataviz-logement-social",
    title: "DataViz Logement Social",
    description:
      "SAÉ 401 (BUT MMI) : tableau de bord pour analyser le logement social en France (INSEE, RPLS) sur 100 départements et trois années (2021–2023). Application non hébergée : aperçu via les captures d'écran ci-dessous.",
    context:
      "Projet universitaire (SAÉ 401, BUT MMI) : un tableau de bord destiné aux décideurs publics pour analyser et visualiser les données du logement social en France, issues de l'INSEE et du RPLS, couvrant les 100 départements sur la période 2021–2023. L'objectif était de permettre à des profils non techniques de tirer des constats concrets sur l'état du logement social par région et par département, grâce à des visualisations claires et comparables (indicateurs clés, démographie, logement, évolutions). Côté front : React 19, Vite, Tailwind CSS 4, Chart.js, TanStack Query, React Router et Axios. Côté back : Symfony exposant une API REST pour les données.",
    difficulties:
      "Structurer et agréger des jeux de données territoriaux volumineux tout en gardant des temps de réponse acceptables, avec mise en cache et requêtes côté client (TanStack Query). Concevoir des graphiques Chart.js lisibles (échelles, légendes, couleurs) pour des non-spécialistes. Gérer le filtrage par année de référence et la navigation (accueil, régions, départements, comparateur) avec React Router. Coordonner le contrat API entre Symfony et le front (Axios, gestion des erreurs). Assurer une interface cohérente en dark mode et un export visuel (PNG) pour certaines vues.",
    techs: [
      "React",
      "Vite",
      "Tailwind CSS",
    ...
    screens: [
      "/img/dataviz_logement_regions.png",
      "/img/dataviz_logement_departement.png",
      "/img/dataviz_logement_evolution.png",
    ],
  },
  {
    id: "sushy-crousty",
...
export const ABOUT_DATA = {
  ...
  paragraph:
    "Futur développeur full-stack en formation MMI, je conçois et développe des applications web complètes. J'apprends React, Angular, PHP, TypeScript et Tailwind, et je reste curieux d'explorer de nouvelles technologies.",
  cta: "En savoir plus",
};
