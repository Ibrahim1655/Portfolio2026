...
export const PROJECTS_DATA: Project[] = [
  ...
  },
  {
    ...
    description: 'Création d\'une plateforme de réservation de matériel dans le cadre d\'une SAE (Situation d\'Apprentissage et d\'Évaluation). Pour consulter le site sans créer de compte : identifiant ibrahim.drame, mot de passe ibrahim.',
    context: 'Projet réalisé dans le cadre de la SAE 302, qui consistait à développer une plateforme complète de réservation de matériel. Le système devait permettre aux utilisateurs de consulter le catalogue de matériel disponible, de réserver des équipements pour des périodes spécifiques, et de gérer leurs réservations. Le site nécessitait également un espace d\'administration pour gérer le catalogue, les stocks, les réservations en cours et les utilisateurs. L\'objectif était de créer un système fonctionnel et sécurisé qui gère efficacement les ressources partagées, avec une interface intuitive pour les utilisateurs finaux et des outils de gestion pour les administrateurs. Pour consulter le site sans créer de compte : identifiant ibrahim.drame, mot de passe ibrahim.',
