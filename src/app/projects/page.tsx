  ...
  return (
    <motion.div variants={item} whileHover={{ x: 8 }} className="group">
      <Link
        ...
        className="w-full text-left py-10 md:py-12 border-b border-amber-500/20 hover:border-amber-500/40 hover:bg-zinc-900/50 transition-colors duration-300 flex flex-col md:flex-row md:items-center gap-4 md:gap-8"
      >
        <span className="text-sm font-mono text-amber-400/80 min-w-[60px]">{year}</span>
        <div className="flex-1 min-w-0">
          <h3 className="text-xl md:text-2xl font-bold text-zinc-300 group-hover:text-white transition-colors duration-300 mb-2">
            {project.title}
          </h3>
        ...
        <span className="text-zinc-400 group-hover:text-amber-400 group-hover:translate-x-2 transition-all duration-300 hidden md:inline-flex">
